...
// EncodeDefault implementation of EncodeDefault method of DataTypeEncoder interface for TypeLongLong
...
func init() {
	type_awareness.RegisterMySQLDataTypeIDEncoder(uint32(base_mysql.TypeLongLong), &LongLongDataTypeEncoder{})
}
