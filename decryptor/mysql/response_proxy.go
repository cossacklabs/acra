...
func NewMysqlHandler(decryptor base.Decryptor, dbConnection, clientConnection net.Conn, tlsConfig *tls.Config, firewall acracensor.FirewallInterface) (*MysqlHandler, error) {
