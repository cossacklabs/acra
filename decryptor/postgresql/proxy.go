...
func (factory *proxyFactory) New(clientID []byte, clientSession base.ClientSession) (base.Proxy, error) {
	...
	if storeMask&(config.SettingSearchFlag|config.SettingMaskingFlag|config.SettingTokenizationFlag|config.SettingDefaultDataValueFlag|config.SettingDataTypeFlag) > 0 {
