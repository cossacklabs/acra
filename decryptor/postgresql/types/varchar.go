...
// VarcharDataType is encoder of varcharOID type in PostgreSQL
type VarcharDataType struct{}

// Encode implementation of Encode method of DataTypeEncoder interface for textOID
func (t *VarcharDataType) Encode(ctx context.Context, data []byte, format type_awareness.DataTypeFormat) (context.Context, []byte, error) {
...
func (t *VarcharDataType) Decode(ctx context.Context, data []byte, format type_awareness.DataTypeFormat) (context.Context, []byte, error) {
...
func (t *VarcharDataType) EncodeOnFail(ctx context.Context, format type_awareness.DataTypeFormat) (context.Context, []byte, error) {
...
// ValidateDefaultValue implementation of ValidateDefaultValue method of DataTypeEncoder interface for varcharOID
func (t *VarcharDataType) ValidateDefaultValue(value *string) error {
...
func init() {
	type_awareness.RegisterPostgreSQLDataTypeIDEncoder(pgtype.VarcharOID, &VarcharDataType{})
}
