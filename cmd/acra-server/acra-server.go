...
func main() {
	...
	tlsIdentifierExtractorType := flag.String("tls_identifier_extractor_type", network.IdentifierExtractorTypeDistinguishedName, fmt.Sprintf("Type of identifier extractor from TLS certificate to use as ClientID (%s)", strings.Join(network.IdentifierExtractorTypesList, " | ")))
