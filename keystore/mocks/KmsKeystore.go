...
func (_m *Keystore) CreateKey(ctx context.Context, metaData kms.CreateKeyMetadata) (*kms.KeyMetadata, error) {
...
func (_m *Keystore) Decrypt(ctx context.Context, keyID []byte, data []byte, _a3 []byte) ([]byte, error) {
...
func (_m *Keystore) Encrypt(ctx context.Context, keyID []byte, data []byte, _a3 []byte) ([]byte, error) {
	ret := _m.Called(ctx, keyID, data, _a3)
...
func (_m *Keystore) IsKeyExist(ctx context.Context, keyID string) (bool, error) {
