...
func TestPseudoanonymizer_Anonymize(t *testing.T) {
	...
	testcases := []testcase{
		...
		{Value: "string", Type: common.TokenType_String, Context: common.TokenContext{AdditionalContext: []byte(`some context`)}},
		{Value: "string", Type: common.TokenType_String, Context: common.TokenContext{ClientID: []byte(`some context`), AdditionalContext: []byte(`some context`)}},
		...
		{Value: []byte("bytes"), Type: common.TokenType_Bytes, Context: common.TokenContext{AdditionalContext: []byte(`some context2`)}},
		{Value: []byte("bytes"), Type: common.TokenType_Bytes, Context: common.TokenContext{ClientID: []byte(`some context2`), AdditionalContext: []byte(`some context2`)}},
		...
		{Value: int32(1), Type: common.TokenType_Int32, Context: common.TokenContext{AdditionalContext: []byte(`some context3`)}},
		{Value: int32(1), Type: common.TokenType_Int32, Context: common.TokenContext{ClientID: []byte(`some context3`), AdditionalContext: []byte(`some context3`)}},
		...
		{Value: int64(1), Type: common.TokenType_Int64, Context: common.TokenContext{AdditionalContext: []byte(`some context4`)}},
		{Value: int64(1), Type: common.TokenType_Int64, Context: common.TokenContext{ClientID: []byte(`some context4`), AdditionalContext: []byte(`some context4`)}},
		...
		{Value: common.Email("string"), Type: common.TokenType_Email, Context: common.TokenContext{AdditionalContext: []byte(`some context5`)}},
		{Value: common.Email("string"), Type: common.TokenType_Email, Context: common.TokenContext{ClientID: []byte(`some context5`), AdditionalContext: []byte(`some context5`)}},
	}
...
func TestPseudoanonymizer_AnonymizeConsistentlySameValueDifferentContext(t *testing.T) {
	...
	testcases := []testcase{
		...
		{Value: "string", Type: common.TokenType_String, Context: common.TokenContext{AdditionalContext: []byte(`some context`)}},
		{Value: "string", Type: common.TokenType_String, Context: common.TokenContext{AdditionalContext: []byte(`some context2`)}},
		...
		{Value: []byte("bytes"), Type: common.TokenType_Bytes, Context: common.TokenContext{ClientID: []byte(`some context2`)}},
		{Value: []byte("bytes"), Type: common.TokenType_Bytes, Context: common.TokenContext{AdditionalContext: []byte(`some context`)}},
		{Value: []byte("bytes"), Type: common.TokenType_Bytes, Context: common.TokenContext{AdditionalContext: []byte(`some context2`)}},
		...
		{Value: int32(1), Type: common.TokenType_Int32, Context: common.TokenContext{AdditionalContext: []byte(`some context`)}},
		{Value: int32(1), Type: common.TokenType_Int32, Context: common.TokenContext{AdditionalContext: []byte(`some context2`)}},
		...
		{Value: int64(1), Type: common.TokenType_Int64, Context: common.TokenContext{AdditionalContext: []byte(`some context`)}},
		{Value: int64(1), Type: common.TokenType_Int64, Context: common.TokenContext{AdditionalContext: []byte(`some context2`)}},
		...
		{Value: common.Email("email@example.com"), Type: common.TokenType_Email, Context: common.TokenContext{AdditionalContext: []byte(`some context`)}},
		{Value: common.Email("email@example.com"), Type: common.TokenType_Email, Context: common.TokenContext{AdditionalContext: []byte(`some context2`)}},
	}
