...
func CheckOneKey() {
	keys_path := []string{
		...
		"src/github.com/cossacklabs/acra/benchmarks/.acrakeys/onekey_decrypt",
		"src/github.com/cossacklabs/acra/benchmarks/.acrakeys/onekey_decrypt.pub",
	}
...
func GetPublicOneKey() *keys.PublicKey {
	public_key, err := utils.LoadPublicKey("src/github.com/cossacklabs/acra/benchmarks/.acrakeys/onekey_decrypt.pub")
	if err != nil {
		panic(err)
	}
	return public_key
